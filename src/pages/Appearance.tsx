    ...
    <div>
      ...
      <div className="card mt-6">
        ...
        <div className="card-body space-y-4">
          {/* Buttons preview */}
          <div>
            <p className="text-sm mb-2" style={{ color: 'var(--theme-content-text-muted)' }}>Кнопки</p>
          ...
          {/* Badges preview */}
          <div>
            <p className="text-sm mb-2" style={{ color: 'var(--theme-content-text-muted)' }}>Бейджи</p>
            <div className="flex flex-wrap gap-2">
          ...
          {/* Form preview */}
          <div>
            <p className="text-sm mb-2" style={{ color: 'var(--theme-content-text-muted)' }}>Поля ввода</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input type="text" className="input" placeholder="Текстовое поле" />
          ...
          {/* Table preview */}
          <div>
            <p className="text-sm mb-2" style={{ color: 'var(--theme-content-text-muted)' }}>Таблица</p>
            <div className="table-container">
              <table className="data-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>2</td>
                    <td>Ещё одна запись</td>
                    <td><span className="badge-warning">Ожидание</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
